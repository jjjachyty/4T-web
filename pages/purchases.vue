<template>
    <v-app>
      ...
      <v-flex offset-md3 md5>
        <v-text-field  prepend-inner-icon="search" @click:clear="clear" @keyup.enter="serach" v-model="keyWords" solo clearable placeholder="搜索可代购单 例：香港 IPhonex "></v-text-field>
      </v-flex>
    </v-layout>
                    <v-layout>
